...
5. 创建并推送 `v*` tag。GitHub Actions `Release` workflow 会构建 Windows Setup、Windows Portable、macOS Apple Silicon/Intel Portable 与签名 Android APK，并生成 `release_manifest.json`、`checksums.txt` 和 Release notes。
